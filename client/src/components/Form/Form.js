  ...
  return (
    <div className="memoriesFormCard">
      <form autoComplete="off" noValidate className="memoriesForm" onSubmit={handleSubmit}>
        ...
        <input className="focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md mb-3" name="title" label="Title" placeholder="Enter title..." value={postData.title} onChange={(e) => setPostData({ ...postData, title: e.target.value })} />
        <input className="focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md mb-3" name="message" label="Message" placeholder="Enter message..." value={postData.message} onChange={(e) => setPostData({ ...postData, message: e.target.value })} />
        <input className="focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md mb-3" name="tags" label="Tags (coma separated)" placeholder="Ex: tag1, tag2" value={postData.tags} onChange={(e) => setPostData({ ...postData, tags: e.target.value.split(',') })} />
